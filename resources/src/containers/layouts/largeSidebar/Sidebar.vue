        ...
        >
          ...
          >
            <router-link tag="a" class to="/app/sale_return/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('AddSaleReturn')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
          ...
          >
            <router-link tag="a" class to="/app/sale_return/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListSalesReturn')}}</span>
            </router-link>
          </li>
        </ul>
        ...
        >
          ...
          >
            <router-link tag="a" class to="/app/purchase_return/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('AddPurchaseReturn')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
          ...
          >
            <router-link tag="a" class to="/app/purchase_return/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListPurchasesReturn')}}</span>
            </router-link>
          </li>
        </ul>
