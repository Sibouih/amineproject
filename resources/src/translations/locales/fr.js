...
export default {
    ...
    ClientPayments:'Paiements des clients',
    ...
    Total_in_Words: 'Total en alphabets',
    ...
    Both:'Les deux',
    Both_Price_Cost:'Les deux',
    Cost_Changes:'Changement de coût',
    Price_Changes:'Changement de prix',
    Product_edit:'Modifier le produit',
    All_Changes:'Tous les changements',
    Update_Product:'Modifier le produit',
    Product:'Produit',
    Please_select_a_warehouse_to_view_pricing_history:'Veuillez sélectionner un entrepôt pour voir l\'historique des prix',
    Total_Sale_Due:'Vente totale dû',
    Total_Sell_Return_Due:'Retour de vente total dû',
    Credit_Initial: 'Crédit initial',
    Credit_Achats: 'Credit des achats',
    Total_Credit: 'Total des crédits',
    Total_Cost:'Total coûts',
    Reste_credit: 'Reste crédit',
    Due_Type: 'Type de paiement',
    Seulement_credit_initial: 'Seulement crédit initial',
    Seulement_credit_ventes: 'Seulement crédit ventes',
    Credit_ventes_apres_credit_initial: 'Crédit ventes et après crédit initial',
    Credit_initial_apres_credit_ventes: 'Crédit initial et après crédit ventes',
    ...
    Thank_You_For_Shopping_With_Us: 'Merci pour votre achat',
