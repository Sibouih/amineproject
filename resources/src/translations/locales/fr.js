...
export default {
    ...
    ListExchanges: 'Liste des reprises',
    Deposit_Category: 'Catégorie de dépôt',
    AddProductExchange: 'Faire une reprise',
    ...
    Error: 'Erreur!',
    Storage: 'Storage',
    Enter_Storage: 'Entrer le stockage',
    Battery: 'Battery',
    QuantityStock: 'Quantité en stock',
    Enter_Battery: 'Entrer le niveau de la batterie',
    ...
    Search_a_product: 'Rechercher un produit',
    ...
    Products_to_Purchase: 'Produits à acheter',
    Products_to_Sell: 'Produits à vendre',
