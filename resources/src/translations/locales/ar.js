...
export default {
    ...
    Credit_Ventes: 'كريدي المبيعات',
    Reste_credit: 'الباقي الكلي',
    DirectPayments: 'دفعات المبيعات',
    GlobalPayments: 'دفعات الزبائن',
    Number_of_Products: 'عدد المنتجات',
    Total_in_Words: 'المجموع بالحروف',
    Adress: 'العنوان',
    Seulement_credit_ventes: 'كريدي المبيعات فقط',
    Credit_ventes_apres_credit_initial: 'كريدي المبيعات ثم الكريدي الاصلي',
    Credit_initial_apres_credit_ventes: 'الكريدي الاصلي ثم كريدي المبيعات',
    Thank_You_For_Shopping_With_Us: 'شكرًا لك على تعاملكم معنا',
    Credit_Initial: 'الكريدي الاصلي',
    Credit_Achats: 'كريدي المشتريات',
    Credit_Vente: 'كريدي المبيعات',
    Total_Credit: 'الكريدي المتبقي',
    Total_Prix: 'مجموع السعر',
    Total_Profit: "مجموع الربح",
    Due_Type: 'نوع الدفع',
    Seulement_credit_initial: 'الكريدي الاصلي فقط',
    Seulement_credit_achats: 'كريدي المشتريات فقط',
    Credit_achats_apres_credit_initial: 'كريدي المشتريات ثم الكريدي الاصلي',
    Credit_initial_apres_credit_achats: 'الكريدي الاصلي ثم كريدي المشتريات',
    Paying_amount_is_greater_than_Credit_Initial: 'المبلغ الدفوع اكبر من الكريدي الاصلي',
    Paying_amount_is_greater_than_Total_Credit: 'المبلغ المدفوع اكبر من الكريدي المتبقي ',
    ...
    SalesReturn:'مرجوعات الزبائن',
    ListSalesReturn: 'قائمة مرجوعات المبيعات',
    CreatePurchaseReturn:'إنشاء إرجاع الشراء',
    EditPurchaseReturn:'تحرير إرجاع الشراء',
    PurchasesReturn:'مرجوعات المزودين',
    Due:'الكريدي المتبقي',
    Profit: 'ربح',
    Revenue: 'دخل',
    ...
    Return_Info: 'معلومات المرجوعات',
    Expense_Category: 'فئة المصاريف',
    Create_Expense: 'أضف المصاريف',
    Details: 'تفاصيل',
    Discount_Method: 'طريقة الخصم',
    Net_Unit_Cost: 'الثمن',
    Net_Unit_Price: 'سعر الوحدة',
    ...
    PaymentsReturns: 'مدفوعات المرجوعات',
    ProfitandLoss: 'الربح والخسارة',
    Profit_Net: 'الربح الصافي',
    ...
    Balance: 'الرصيد',
    QtyBack: 'كمية المرجوعات',
    TotalReturn: 'مجموع المرجوعات',
    MontantReste: 'المبلغ المتبقي',
    SaleDetail: 'تفاصيل المبيعة',
    EditSale: 'تعديل المبيعة',
    AddSale: 'إضافة مبيعة',
    AddSaleReturn: 'إضافة رجوع مبيعة',
    ...
    Total_Sale: 'مجموع المبيعات',
    ClientPayments: 'مدفوعات الزبائن',
    ...
    AddPurchaseReturn: 'إضافة مرجوع شراء',
    ListPurchasesReturn: 'قائمة مرجوعات المشتريات',
    ...
    Total_Sell_Return_Due:'إجمالي الديون المرجوعات',
    ...
    Export_clients: 'طباعة لائحة الزبائن',
    ...
    Warehouse:'المستودع',
    Optional_for_warehouse_specific_pricing:'اختياري - لاسعار و كلفات محددة',
    You_are_editing_global_product_pricing:'أنت تعدل أسعار المنتجات العامة',
    Select_a_warehouse_to_set_warehouse_specific_prices_or_leave_empty_for_global_pricing:'اختر مستودع لتعيين أسعار محددة أو تركها فارغة للأسعار العامة',
    Select_Warehouse:'اختر المستودع',
    Select_Warehouse_to_Continue:'اختر المستودع للاستمرار',
    Please_select_warehouse_above_to_view_and_manage_product_pricing_for_that_warehouse:'يرجى اختيار المستودع أعلاه لعرض وإدارة أسعار المنتجات لهذا المستودع',
    Please_select_a_warehouse_to_view_pricing_history:'يرجى اختيار مستودع لعرض تاريخ الأسعار',
    Global:'عام',
    Reason:'السبب',
    Changed_By:'المستخدم',
    Both:'السعر والتكلفة',
    No_reason_provided:'لا يوجد سبب',
    The_Global:'العام',
    Product:'المنتج',
    Global_cost:'التكلفة العامة',
    Global_price:'السعر العام',
    Both_Price_Cost:'السعر والتكلفة',
    Cost_Changes:'تغيير التكلفة',
    Price_Changes:'تغيير السعر',
    ...
    Warehouse_Pricing:'أسعار المستودع',
    Pricing_History:'تاريخ الأسعار',
    Sell_Return:'عائد بيع',
    Purchase_Return:'إرجاع الشراء',
    Filter_by_Product:'البحث  عن المنتج',
    All_Products:'جميع المنتجات',
    Clear_Filters:'مسح الفلتر',
    Tax_Number:'الرقم الضريبي',
    Product_create_default:'إنشاء منتج',
    No_Change:'لا يوجد تغيير',
    Pay_Due:'دفع الديون',
    Sales_Returns:'مرجوعات الزبائن',
    Purchase_Returns:'مرجوعات المزودين',
    ...
    Total_Purchase_Return_Due:'إجمالي  مرجوعات الشراء',
    Purchase_return_due:'ديون  مرجوعات الشراء',
