<template>
  <div class="main-content">
    ...
    <validation-observer ref="new_purchase_return" v-if="!isLoading">
      <b-form @submit.prevent="Submit_new_purchase_return">
        <b-row>
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                      ...
                      <tbody>
                        ...
                        <tr v-for="detail  in details" >
                          ...
                          <td>
                            ...
                            <span class="badge badge-warning" v-else>{{detail.stock}} {{detail.unitPurchase}}</span>
                          </td>
                          <td>
                            <div class="quantity">
                              <b-input-group>
                ...
                <b-col md="12">
                  <b-form-group>
                    <b-button variant="primary" :disabled="paymentProcessing" @click="Submit_new_purchase_return"><i class="i-Yes me-2 font-weight-bold"></i> {{$t('submit')}}</b-button>
...
export default {
  ...
  methods: {
    ...
    handleBlur() {
     ...
     //---------------------- Event Select Payment Method ------------------------------\\
      ...
      if (value === 'credit card') {
        ...
        await axios.get(`/retrieve-customer?customerId=${this.purchase_return.supplier_id}`)
            .then(response => {
    ...
    Submit_new_purchase_return() {
      this.$refs.new_purchase_return.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
    ...
    search(){
      ...
      console.log('this.purchase_return.warehouse_id', this.purchase_return.warehouse_id);
    ...
    Get_Products_By_Warehouse(id) {
      // Start the progress bar.
        ...
        NProgress.set(0.1);
      axios
        .get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&is_purchase=" + 1 + "&product_service=" + 1)
         .then(response => {
