<template>
  <div class="main-content">
    ...
    <validation-observer ref="new_sale_return" v-if="!isLoading">
      <b-form @submit.prevent="Submit_new_sale_return">
        <b-row>
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                ...
                <b-col md="12">
                  <b-form-group>
                    <b-button variant="primary" :disabled="paymentProcessing" @click="Submit_new_sale_return"><i class="i-Yes me-2 font-weight-bold"></i> {{$t('submit')}}</b-button>
...
export default {
  ...
  methods: {
    ...
    handleBlur() {
     ...
     //---------------------- Event Select Payment Method ------------------------------\\
      ...
      if (value === 'credit card') {
        ...
        await axios.get(`/retrieve-customer?customerId=${this.sale_return.client_id}`)
            .then(response => {
    ...
    Submit_new_sale_return() {
      this.$refs.new_sale_return.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
