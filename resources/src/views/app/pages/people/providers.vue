            ...
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Credit_Initial')">
                  <b-form-input
                    ...
                    v-model="provider.credit_initial"
            ...
            <b-col lg="6" md="12" sm="12">
              ...
              >
                <b-form-group :label="$t('Paying_Amount') + ' ' + '*'">
                  ...
                  <ul>
                    <li><span class="badge badge-success">{{$t('Credit_Achats')}} : {{currentUser.currency}} {{payment.due}}</span></li>
          ...
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                ...
                <th>{{currentUser.currency}} {{provider.credit_initial}}</th>
              </tr>
              <tr>
                <!-- Provider City -->
                <td>{{$t('City')}}</td>
  ...
  methods: {
    ...
    Verified_paidAmount() {
      if (isNaN(this.payment.amount)) {
        ...
        else if (this.payment.due_type == 'credit_achats_only' && this.payment.amount > this.payment.due) {
          warning = true
        }
        else if ((this.payment.due_type == 'credit_achats_first' || this.payment.due_type == 'credit_initial_first') && this.payment.amount > (this.payment.due + this.payment.credit_initial)) {
          warning = true
