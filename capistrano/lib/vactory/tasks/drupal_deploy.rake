...
# Install composer 2.
namespace :composer2 do
  desc "Install Composer 2"
  task :install do
    on roles(:app) do
      within deploy_to do
        execute "rm #{deploy_to}/composer.phar || echo \"#{deploy_to}/composer.phar file doesn't exist.\""
        #execute "wget https://getcomposer.org/download/2.0.9/composer.phar"
        execute :wget, "https://getcomposer.org/download/2.5.4/composer.phar"
